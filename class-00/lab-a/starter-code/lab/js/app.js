...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT - CH RESPONSE: when using 'let' you're essentially declaring a variable that only exists within a block statement. Since the (now deleted) console.log referenced 'rando' outside of the block statement, it did not exist, couldn't be found, and threw an error.
  console.log(viewed);
